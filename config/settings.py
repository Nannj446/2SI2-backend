...
INSTALLED_APPS = [
    ...
    'api.insurances',  # Gestión de Seguros Asociados al Crédito
]
...
# Stripe URLs for Checkout and Portal
STRIPE_SUCCESS_URL = os.getenv('STRIPE_SUCCESS_URL', f'{FRONTEND_URL}/subscription/success?session_id={{CHECKOUT_SESSION_ID}}')
STRIPE_CANCEL_URL = os.getenv('STRIPE_CANCEL_URL', f'{FRONTEND_URL}/subscription/plans?canceled=true')

# Billing Configuration (for SaaS subscriptions)
BILLING_TRIAL_DAYS = int(os.getenv('BILLING_TRIAL_DAYS', 30))
BILLING_GRACE_PERIOD_HOURS = int(os.getenv('BILLING_GRACE_PERIOD_HOURS', 48))
BILLING_SUSPENSION_AFTER_DAYS = int(os.getenv('BILLING_SUSPENSION_AFTER_DAYS', 7))
